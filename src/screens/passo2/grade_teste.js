          ...
          <div class="row" id="row">
            ...
            <div class="col-sm-9">
              ...
              <div class="row" id="row">
                ...
                {this.state.carregouHorario ?
                  <div class="col-sm" id="cadastro_turmas_retangulo" onClick={() => this.cadastrarHorario()}>
                    {this.state.arrayQuadro[0].nome}
                  </div>
                  :
                  <div class="col-sm" id="cadastro_turmas_retangulo" onClick={() => this.cadastrarHorario()}>
                    {/* {this.state.arrayQuadro.nome} */}
                  </div>
                }
                <div class="col-sm" id="cadastro_turmas_retangulo">
                  {/* {this.state.arrayQuadro[0].nome} */}
